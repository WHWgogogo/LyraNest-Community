...
const TOKEN_KEY = "harmony-music.auth-token";
...
export default function App() {
  ...
  const listeningEvents = useListeningEvents({ api, userKey });
  ...
  const player = useAudioPlayer({
    ...
    onListeningEvent: listeningEvents.record,
  });
